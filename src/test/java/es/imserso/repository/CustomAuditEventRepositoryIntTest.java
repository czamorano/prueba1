package es.imserso.repository;

import es.imserso.Prueba1App;
import es.imserso.config.Constants;
import es.imserso.config.audit.AuditEventConverter;
import es.imserso.domain.PersistentAuditEvent;
...
import static es.imserso.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
