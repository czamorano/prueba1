package es.imserso.web.rest;

import es.imserso.config.Constants;
import es.imserso.Prueba1App;
import es.imserso.domain.Authority;
import es.imserso.domain.User;
import es.imserso.repository.AuthorityRepository;
import es.imserso.repository.UserRepository;
import es.imserso.security.AuthoritiesConstants;
import es.imserso.service.MailService;
import es.imserso.service.dto.UserDTO;
import es.imserso.service.dto.PasswordChangeDTO;
import es.imserso.web.rest.errors.ExceptionTranslator;
import es.imserso.web.rest.vm.KeyAndPasswordVM;
import es.imserso.web.rest.vm.ManagedUserVM;
import es.imserso.service.UserService;
